...
import { getSidebar, requireAdmin, requireAuth, requireTeacher, user } from "~/services/auth.server";
        ...
        {cursos.length === 0 ? (
          ...
          cursos.map((curso: any) => (
            <div key={curso.id} className="bg-white rounded-xl shadow p-6 border border-[#008999] relative mb-8">
              ...
              <button
                className="absolute top-4 right-4 bg-red-500 hover:bg-red-600 text-white rounded-lg px-3 py-1 font-bold transition"
